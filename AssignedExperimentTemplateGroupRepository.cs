...
public sealed class AssignedExperimentTemplateGroupRepository(DataBaseContext dataBaseContext) : GenericRepository<AssignedExperimentTemplateGroup>(dataBaseContext), IAssignedExperimentTemplateGroupRepository
{
}
