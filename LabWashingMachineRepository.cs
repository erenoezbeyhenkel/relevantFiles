...
public sealed class LabWashingMachineRepository(DataBaseContext dataBaseContext) : GenericRepository<LabWashingMachine>(dataBaseContext), ILabWashingMachineRepository
{
}
