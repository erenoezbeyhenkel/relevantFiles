...
public sealed class ProductSetupAdditiveRepository(DataBaseContext dataBaseContext) : GenericRepository<ProductSetupAdditive>(dataBaseContext), IProductSetupAdditiveRepository
{
}
